                  ...
                  <div className="space-y-4">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">Instant responses during business hours</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">Get immediate answers to your queries</p>
                      </div>
                    </div>
                ...
                <CardContent className="p-6 space-y-6">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">support@stackcart.in</p>
                      <p className="text-gray-500 text-xs">
