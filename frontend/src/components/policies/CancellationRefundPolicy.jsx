    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 p-8">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="mb-4">
            <strong>Last updated on Aug 13, 2025</strong>
          </p>

          <p>
            StackCart believes in helping its customers as far as possible, and
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>
              In case of any Refunds approved by StackCart, it'll take 3-5 days
              for the refund to be credit to the end customer.
            </li>
          </ul>
        </div>
      </main>
