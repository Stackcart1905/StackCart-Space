      ...
      <div className="relative flex flex-col lg:flex-row items-center max-w-7xl mx-auto gap-12">
        ...
        <div className="flex-1 text-center lg:text-left">
          ...
          <h1 className="text-4xl lg:text-6xl font-bold text-slate-900 mb-6 leading-tight">
            ...
            <br />
            <span className="text-3xl lg:text-5xl">Your Complete Online Selling Solution</span>
          </h1>
          
          {/* Subtext */}
          <p className="text-xl text-slate-600 mb-10 leading-relaxed max-w-2xl mx-auto lg:mx-0">
            We build your store, market your products, and grow your sales — all in one place. 
            Transform your business idea into a thriving online empire.
          </p>
              ...
              <CardContent className="p-8 text-center">
                ...
                <div className="space-y-6">
                  <div className="relative">
                    ...
                    <p className="text-slate-700 font-semibold mt-3">Code & Design</p>
                  </div>
                  ...
                  <div className="relative">
                    ...
                    <p className="text-slate-700 font-semibold mt-3">E-commerce Store</p>
                  </div>
                  ...
                  <div className="relative">
                    ...
                    <p className="text-slate-700 font-semibold mt-3">Sales Growth</p>
                  </div>
                </div>
              </CardContent>
            </Card>
