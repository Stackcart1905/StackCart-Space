...
router.post("/", protectRoute, uploadMiddleware.single("clientPhoto"), createTestimonial);
router.patch("/:id", protectRoute, uploadMiddleware.single("clientPhoto"), updateTestimonial); 
