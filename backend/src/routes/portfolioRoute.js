...
router.post("/", protectRoute, uploadMiddleware.fields([ // Use .fields for multiple data of req.file
  { name: 'beforeImage', maxCount: 1 },
  { name: 'afterImage', maxCount: 1 }
]), createPortfolio); 

router.patch("/:id", protectRoute, uploadMiddleware.fields([ //  Use .fields for updates multi data req.file
  { name: 'beforeImage', maxCount: 1 },
  { name: 'afterImage', maxCount: 1 }
]), updatePortfolio); 
